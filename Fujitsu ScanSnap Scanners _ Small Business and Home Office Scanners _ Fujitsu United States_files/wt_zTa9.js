...
//Tag Version: Fujitsu 1.1./05-02-07
var gTagVer = "Fujitsu 1.1/05-02-07";
var gService = true;
var gTimeZone = 0;
function dcsCookie(){
...
function dcsIsOnsite(host){
	...
	if (gTrackOffSiteLinks==0){return 1;}

	var aDoms=gProductionDomains.split(',');
...
function dcsVar(){
	...
	//WT.sp="@@SPLITVALUE@@";
	WT.dl="0";
	//use this value for unique identifier
...
/*
     FILE ARCHIVED ON 21:42:58 May 18, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:47:39 Aug 10, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 0.766
  captures_list: 0.866
  exclusion.robots: 0.075
  exclusion.robots.policy: 0.058
  esindex: 0.011
  cdx.remote: 6.896
  LoadShardBlock: 114.414 (3)
  PetaboxLoader3.datanode: 123.441 (4)
  load_resource: 31.933
*/